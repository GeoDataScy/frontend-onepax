...
import { Plus, X, Send, Loader2, AlertCircle, FileText } from "lucide-react";
...
export default function Briefing() {
    ...
    const isFormValid =
        form.companhia_aerea.trim() &&
        form.cliente_final.trim() &&
        form.data.length === 10 &&
        form.numero_voo.trim() &&
        form.unidade_maritima.trim() &&
            ...
            >
                ...
                >
                    <div>
                        ...
                        >
                            Gerenciamento de registros operacionais
                        </p>
                    </div>
                    ...
                    >
                        <form onSubmit={handleSubmit}>
                            ...
                            >
                                ...
                                {/* Unidade Marítima */}
                                <div>
                                    <label style={labelStyle}>Unidade Marítima</label>
                                    <input
                                        type="text"
                                ...
                                {isLoading ? (
                                    ...
                                    records.map((record, idx) => (
                                        ...
                                        >
                                            ...
                                            <td style={cellStyle}>{record.solicitante}</td>
                                        </tr>
                                    ))
                                )}
                            </tbody>
